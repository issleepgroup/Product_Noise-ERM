...
def amp_run_classification(x, y, loss_func, grad_func,
    ...
    # sigma_1
    std_dev_obj = sensitivity_obj * math.sqrt(t_squared) / eps_p
    # sigma_2
    std_dev_out = sensitivity_out * math.sqrt(t_squared) / eps_out
    ...
    noise_obj = std_dev_obj * z * h
    noise_out = std_dev_out * z * h
    ...
    # add the noise to loss function
    ...
    # add the noise to gradient function
